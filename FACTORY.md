...
- **[2026-05-24]**: Fixed SBR minigame mechanics by removing the upward speed multiplier that was causing the ball to continuously gain speed. Swapped the flipped left/right instruction images in the calibration overlay.
